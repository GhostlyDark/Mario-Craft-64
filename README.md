...
> [!NOTE]
> For sm64coopdx, the pack goes into `dynos/packs`, with a directory such as `dynos/packs/Mario Craft 64` containing the folders `actors`, `levels` and `textures`.
...
- **GhostlyDark:** Porting work and texture fixes (duplicates, odd resolutions, seams)
- **Hypatia:** Main creator of Mario Craft 64 - she loves u
